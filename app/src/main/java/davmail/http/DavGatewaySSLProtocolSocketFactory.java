...
//        	//XXX - UI Listner         DavGatewayTray.error(new BundleMessage("LOG_INVALID_URL", urlString));
//        }
//XXX - Assume no cert magic for now    	
    }
...
//                }
//            });
//XXX - Runtime credential gathering     
        	throw new RuntimeException(" Need Credentials");
        }
    }
