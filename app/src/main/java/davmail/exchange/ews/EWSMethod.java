...
public abstract class EWSMethod extends PostMethod {
    protected static final Logger LOGGER = LoggerFactory.getLogger(EWSMethod.class);
            ...
            inputStream = new FilterInputStream(inputStream) {
                ...
                public int read(byte[] buffer, int offset, int length) throws IOException {
                    ...
                    if (totalCount - lastLogCount > 1024 * 128) {
                    	//XXX - UI Listner                        DavGatewayTray.debug(new BundleMessage("LOG_DOWNLOAD_PROGRESS", String.valueOf(totalCount / 1024), EWSMethod.this.getURI()));
