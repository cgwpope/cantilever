...
import com.google.code.cantilever.javax.xml.stream.XMLInputFactory;
...
public final class XMLStreamUtil {
    private static final Logger LOGGER = LoggerFactory.getLogger(XMLStreamUtil.class);
    ...
    public static XMLInputFactory getXmlInputFactory() {
        XMLInputFactory inputFactory = new com.ctc.wstx.stax.WstxInputFactory();
