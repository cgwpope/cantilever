...
public abstract class ExchangeSession {
    ...
    protected static final Logger LOGGER = LoggerFactory.getLogger("davmail.exchange.ExchangeSession");
    ...
    public ExchangeSession(String url, String userName, String password) throws IOException {
        ...
        try {
            ...
            ExchangeSession.LOGGER.error(message.format());
...
//                        ((PostMethod) logonMethod).addParameter(name, DavGatewayOTPPrompt.getOneTimePassword());
                    	//XXX - Handle Challenge Authentication
                    	throw new RuntimeException("Need challemnge handled");
