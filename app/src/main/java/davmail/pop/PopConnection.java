...
public class PopConnection extends AbstractConnection {
    private static final Logger LOGGER = LoggerFactory.getLogger(PopConnection.class);
                        ...
                        if ("STAT".equalsIgnoreCase(command)) {
                            ...
                            if (tokens.hasMoreTokens()) {
                                try {
                                	...
                                	//XXX - UI Listner       DavGatewayTray.error(new BundleMessage("LOG_ERROR_RETRIEVING_MESSAGE"), e);
